...
export class EventProvider {
  ...
  getEventDetail(eventId:string): firebase.database.Reference {
    ...
    createHistory(name: string, price: number, date: string, 
      location: number, destination: number): any{
  ...
  PushUserDetails(name: string, picture: any, 
    lat: number, lng: number, locationName: any, payWith: any): Promise<any> {
  ...
  UpdateDestination(
    destinationName: any, price: any, id: any): Promise<any> {
  ...
  UpdateCard(card: string, month: any, year: any, cvc: any, amount: any, email: any, driverPay: any): Promise<any> {
